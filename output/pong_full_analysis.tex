...
C_4 &= (p > 1) \\
C_5 &= (p - 1) \\
C_6 &= (C_7 \cdot C_10 + (1 - C_7) \cdot p) \\
C_7 &= (C_8 \land C_9) \\
C_8 &= (C_3 = 115) \\
C_9 &= (p < 18) \\
C_10 &= (p + 1) \\
C_11 &= (C_12 < 1) \\
C_12 &= (b + d) \\
C_13 &= (C_14 \cdot C_17 + (1 - C_14) \cdot C_18) \\
C_14 &= (C_15 \land C_16) \\
C_15 &= (C_3 = 105) \\
C_16 &= (q > 1) \\
C_17 &= (q - 1) \\
C_18 &= (C_19 \cdot C_22 + (1 - C_19) \cdot q) \\
C_19 &= (C_20 \land C_21) \\
C_20 &= (C_3 = 107) \\
C_21 &= (q < 18) \\
C_22 &= (q + 1) \\
...
\begin{align*}
b[t+1] &= (C_11 \cdot 40 + (1 - C_11) \cdot (C_23 \cdot 40 + (1 - C_23) \cdot C_12))\\
c[t+1] &= (C_11 \cdot 12 + (1 - C_11) \cdot (C_23 \cdot 12 + (1 - C_23) \cdot C_24))\\
d[t+1] &= \parbox[t]{0.8\linewidth}{(((((C_12 = 2) \land (C_24 \geq C_0)) \land (C_24 < (C_0 + 5))) \lor (((C_12 = 77) \land (C_24 \geq C_13)) \land (C_24 < (C_13 + 5)))) \cdot (0 - d) + (1 - ((((C_12 = 2) \land (C_24 \geq C_0)) \land (C_24 < (C_0 + 5))) \lor (((C_12 = 77) \land (C_24 \geq C_13)) \land (C_24 < (C_13 + 5))))) \cdot d)}\\
e[t+1] &= (((C_24 = 1) \lor (C_24 = 22)) \cdot (0 - e) + (1 - ((C_24 = 1) \lor (C_24 = 22))) \cdot e)\\
f[t+1] &= (C_11 \cdot (f + 1) + (1 - C_11) \cdot f)\\
g[t+1] &= (C_11 \cdot g + (1 - C_11) \cdot (C_23 \cdot (g + 1) + (1 - C_23) \cdot g))\\
p[t+1] &= C_0\\
q[t+1] &= C_13
\end{align*}
...
C_{2}  \cdot  (1 - C_{2}) &= 0\\
C_{2}  \cdot  ((C_{3}) - (119)) &= 0\\
((C_{3}) - (119))  \cdot  e_{0} - (1 - C_{2}) &= 0\\
...
C_{5} - (p - 1) &= 0\\
C_{6} - ((C_{7})  \cdot  (C_{10}) + (1 - C_{7})  \cdot  (p)) &= 0\\
C_{7} - (C_{8}  \cdot  C_{9}) &= 0\\
C_{8}  \cdot  (1 - C_{8}) &= 0\\
C_{8}  \cdot  ((C_{3}) - (115)) &= 0\\
((C_{3}) - (115))  \cdot  e_{12} - (1 - C_{8}) &= 0\\
e_{14} - (18 - 1) &= 0\\
C_{9}  \cdot  (1 - C_{9}) &= 0\\
C_{9}  \cdot  ((e_{14}) - (p) - (e_{15}^{2} + e_{16}^{2} + e_{17}^{2} + e_{18}^{2})) &= 0\\
(1 - C_{9})  \cdot  ((p) - (e_{14}) - 1 - (e_{19}^{2} + e_{20}^{2} + e_{21}^{2} + e_{22}^{2})) &= 0\\
C_{10} - (p + 1) &= 0\\
e_{24} - (1 - 1) &= 0\\
C_{11}  \cdot  (1 - C_{11}) &= 0\\
C_{11}  \cdot  ((e_{24}) - (C_{12}) - (e_{25}^{2} + e_{26}^{2} + e_{27}^{2} + e_{28}^{2})) &= 0\\
(1 - C_{11})  \cdot  ((C_{12}) - (e_{24}) - 1 - (e_{29}^{2} + e_{30}^{2} + e_{31}^{2} + e_{32}^{2})) &= 0\\
C_{12} - (b + d) &= 0\\
C_{13} - ((C_{14})  \cdot  (C_{17}) + (1 - C_{14})  \cdot  (C_{18})) &= 0\\
C_{14} - (C_{15}  \cdot  C_{16}) &= 0\\
C_{15}  \cdot  (1 - C_{15}) &= 0\\
C_{15}  \cdot  ((C_{3}) - (105)) &= 0\\
((C_{3}) - (105))  \cdot  e_{33} - (1 - C_{15}) &= 0\\
e_{36} - (q - 1) &= 0\\
C_{16}  \cdot  (1 - C_{16}) &= 0\\
C_{16}  \cdot  ((e_{36}) - (1) - (e_{37}^{2} + e_{38}^{2} + e_{39}^{2} + e_{40}^{2})) &= 0\\
(1 - C_{16})  \cdot  ((1) - (e_{36}) - 1 - (e_{41}^{2} + e_{42}^{2} + e_{43}^{2} + e_{44}^{2})) &= 0\\
C_{17} - (q - 1) &= 0\\
C_{18} - ((C_{19})  \cdot  (C_{22}) + (1 - C_{19})  \cdot  (q)) &= 0\\
C_{19} - (C_{20}  \cdot  C_{21}) &= 0\\
C_{20}  \cdot  (1 - C_{20}) &= 0\\
C_{20}  \cdot  ((C_{3}) - (107)) &= 0\\
((C_{3}) - (107))  \cdot  e_{45} - (1 - C_{20}) &= 0\\
e_{47} - (18 - 1) &= 0\\
C_{21}  \cdot  (1 - C_{21}) &= 0\\
C_{21}  \cdot  ((e_{47}) - (q) - (e_{48}^{2} + e_{49}^{2} + e_{50}^{2} + e_{51}^{2})) &= 0\\
(1 - C_{21})  \cdot  ((q) - (e_{47}) - 1 - (e_{52}^{2} + e_{53}^{2} + e_{54}^{2} + e_{55}^{2})) &= 0\\
C_{22} - (q + 1) &= 0\\
e_{58} - (C_{12} - 1) &= 0\\
C_{23}  \cdot  (1 - C_{23}) &= 0\\
C_{23}  \cdot  ((e_{58}) - (78) - (e_{59}^{2} + e_{60}^{2} + e_{61}^{2} + e_{62}^{2})) &= 0\\
(1 - C_{23})  \cdot  ((78) - (e_{58}) - 1 - (e_{63}^{2} + e_{64}^{2} + e_{65}^{2} + e_{66}^{2})) &= 0\\
C_{24} - (c + e) &= 0\\
e_{67} - ((C_{23})  \cdot  (40) + (1 - C_{23})  \cdot  (C_{12})) &= 0\\
b[t+1] - ((C_{11})  \cdot  (40) + (1 - C_{11})  \cdot  (e_{67})) &= 0\\
e_{68} - ((C_{23})  \cdot  (12) + (1 - C_{23})  \cdot  (C_{24})) &= 0\\
c[t+1] - ((C_{11})  \cdot  (12) + (1 - C_{11})  \cdot  (e_{68})) &= 0\\
e_{72}  \cdot  (1 - e_{72}) &= 0\\
e_{72}  \cdot  ((C_{12}) - (2)) &= 0\\
((C_{12}) - (2))  \cdot  e_{73} - (1 - e_{72}) &= 0\\
e_{74}  \cdot  (1 - e_{74}) &= 0\\
e_{74}  \cdot  ((C_{24}) - (C_{0}) - (e_{76}^{2} + e_{77}^{2} + e_{78}^{2} + e_{79}^{2})) &= 0\\
(1 - e_{74})  \cdot  ((C_{0}) - (C_{24}) - 1 - (e_{80}^{2} + e_{81}^{2} + e_{82}^{2} + e_{83}^{2})) &= 0\\
...
e_{99}  \cdot  ((C_{12}) - (77)) &= 0\\
((C_{12}) - (77))  \cdot  e_{100} - (1 - e_{99}) &= 0\\
e_{101}  \cdot  (1 - e_{101}) &= 0\\
e_{101}  \cdot  ((C_{24}) - (C_{13}) - (e_{103}^{2} + e_{104}^{2} + e_{105}^{2} + e_{106}^{2})) &= 0\\
(1 - e_{101})  \cdot  ((C_{13}) - (C_{24}) - 1 - (e_{107}^{2} + e_{108}^{2} + e_{109}^{2} + e_{110}^{2})) &= 0\\
...
e_{131} - (f + 1) &= 0\\
f[t+1] - ((C_{11})  \cdot  (e_{131}) + (1 - C_{11})  \cdot  (f)) &= 0\\
e_{133} - (g + 1) &= 0\\
e_{132} - ((C_{23})  \cdot  (e_{133}) + (1 - C_{23})  \cdot  (g)) &= 0\\
g[t+1] - ((C_{11})  \cdot  (g) + (1 - C_{11})  \cdot  (e_{132})) &= 0\\
p[t+1] - (C_{0}) &= 0\\
q[t+1] - (C_{13}) &= 0
\end{align*}
...
& + (C_{2}  \cdot  ((C_{3}) - (119)))^{2} \\
& + (((C_{3}) - (119))  \cdot  e_{0} - (1 - C_{2}))^{2} + (C_{3} - ((kbhit)  \cdot  (getch) \\
& + (1 - kbhit)  \cdot  (0)))^{2} + (e_{3} - (p - 1))^{2} + (C_{4}  \cdot  (1 - C_{4}))^{2} \\
& + (C_{4}  \cdot  ((e_{3}) - (1) - (e_{4}^{2} + e_{5}^{2} + e_{6}^{2} + e_{7}^{2})))^{2} \\
& + ((1 - C_{4})  \cdot  ((1) - (e_{3}) - 1 - (e_{8}^{2} + e_{9}^{2} + e_{10}^{2} \\
& + e_{11}^{2})))^{2} + (C_{5} - (p - 1))^{2} + (C_{6} - ((C_{7})  \cdot  (C_{10}) \\
& + (1 - C_{7})  \cdot  (p)))^{2} + (C_{7} - (C_{8}  \cdot  C_{9}))^{2} \\
& + (C_{8}  \cdot  (1 - C_{8}))^{2} + (C_{8}  \cdot  ((C_{3}) - (115)))^{2} \\
& + (((C_{3}) - (115))  \cdot  e_{12} - (1 - C_{8}))^{2} + (e_{14} - (18 - 1))^{2} \\
& + (C_{9}  \cdot  (1 - C_{9}))^{2} + (C_{9}  \cdot  ((e_{14}) - (p) - (e_{15}^{2} \\
& + e_{16}^{2} + e_{17}^{2} + e_{18}^{2})))^{2} \\
& + ((1 - C_{9})  \cdot  ((p) - (e_{14}) - 1 - (e_{19}^{2} + e_{20}^{2} + e_{21}^{2} \\
& + e_{22}^{2})))^{2} + (C_{10} - (p + 1))^{2} + (e_{24} - (1 - 1))^{2} \\
& + (C_{11}  \cdot  (1 - C_{11}))^{2} + (C_{11}  \cdot  ((e_{24}) - (C_{12}) - (e_{25}^{2} \\
& + e_{26}^{2} + e_{27}^{2} + e_{28}^{2})))^{2} \\
& + ((1 - C_{11})  \cdot  ((C_{12}) - (e_{24}) - 1 - (e_{29}^{2} + e_{30}^{2} + e_{31}^{2} \\
& + e_{32}^{2})))^{2} + (C_{12} - (b + d))^{2} + (C_{13} - ((C_{14})  \cdot  (C_{17}) \\
& + (1 - C_{14})  \cdot  (C_{18})))^{2} + (C_{14} - (C_{15}  \cdot  C_{16}))^{2} \\
& + (C_{15}  \cdot  (1 - C_{15}))^{2} + (C_{15}  \cdot  ((C_{3}) - (105)))^{2} \\
& + (((C_{3}) - (105))  \cdot  e_{33} - (1 - C_{15}))^{2} + (e_{36} - (q - 1))^{2} \\
& + (C_{16}  \cdot  (1 - C_{16}))^{2} + (C_{16}  \cdot  ((e_{36}) - (1) - (e_{37}^{2} \\
& + e_{38}^{2} + e_{39}^{2} + e_{40}^{2})))^{2} \\
& + ((1 - C_{16})  \cdot  ((1) - (e_{36}) - 1 - (e_{41}^{2} + e_{42}^{2} + e_{43}^{2} \\
& + e_{44}^{2})))^{2} + (C_{17} - (q - 1))^{2} + (C_{18} - ((C_{19})  \cdot  (C_{22}) \\
& + (1 - C_{19})  \cdot  (q)))^{2} + (C_{19} - (C_{20}  \cdot  C_{21}))^{2} \\
& + (C_{20}  \cdot  (1 - C_{20}))^{2} + (C_{20}  \cdot  ((C_{3}) - (107)))^{2} \\
& + (((C_{3}) - (107))  \cdot  e_{45} - (1 - C_{20}))^{2} + (e_{47} - (18 - 1))^{2} \\
& + (C_{21}  \cdot  (1 - C_{21}))^{2} + (C_{21}  \cdot  ((e_{47}) - (q) - (e_{48}^{2} \\
& + e_{49}^{2} + e_{50}^{2} + e_{51}^{2})))^{2} \\
& + ((1 - C_{21})  \cdot  ((q) - (e_{47}) - 1 - (e_{52}^{2} + e_{53}^{2} + e_{54}^{2} \\
& + e_{55}^{2})))^{2} + (C_{22} - (q + 1))^{2} + (e_{58} - (C_{12} - 1))^{2} \\
& + (C_{23}  \cdot  (1 - C_{23}))^{2} + (C_{23}  \cdot  ((e_{58}) - (78) - (e_{59}^{2} \\
& + e_{60}^{2} + e_{61}^{2} + e_{62}^{2})))^{2} \\
& + ((1 - C_{23})  \cdot  ((78) - (e_{58}) - 1 - (e_{63}^{2} + e_{64}^{2} + e_{65}^{2} \\
& + e_{66}^{2})))^{2} + (C_{24} - (c + e))^{2} + (e_{67} - ((C_{23})  \cdot  (40) \\
& + (1 - C_{23})  \cdot  (C_{12})))^{2} + (b[t+1] - ((C_{11})  \cdot  (40) \\
& + (1 - C_{11})  \cdot  (e_{67})))^{2} + (e_{68} - ((C_{23})  \cdot  (12) \\
& + (1 - C_{23})  \cdot  (C_{24})))^{2} + (c[t+1] - ((C_{11})  \cdot  (12) \\
& + (1 - C_{11})  \cdot  (e_{68})))^{2} + (e_{72}  \cdot  (1 - e_{72}))^{2} \\
& + (e_{72}  \cdot  ((C_{12}) - (2)))^{2} \\
& + (((C_{12}) - (2))  \cdot  e_{73} - (1 - e_{72}))^{2} + (e_{74}  \cdot  (1 - e_{74}))^{2} \\
& + (e_{74}  \cdot  ((C_{24}) - (C_{0}) - (e_{76}^{2} + e_{77}^{2} + e_{78}^{2} \\
& + e_{79}^{2})))^{2} + ((1 - e_{74})  \cdot  ((C_{0}) - (C_{24}) - 1 - (e_{80}^{2} \\
& + e_{81}^{2} + e_{82}^{2} + e_{83}^{2})))^{2} + (e_{71} - (e_{72}  \cdot  e_{74}))^{2} \\
& + (e_{85} - (C_{0} + 5))^{2} + (e_{88} - (C_{0} + 5))^{2} + (e_{87} - (e_{88} - 1))^{2} \\
...
& + (e_{99}  \cdot  (1 - e_{99}))^{2} + (e_{99}  \cdot  ((C_{12}) - (77)))^{2} \\
& + (((C_{12}) - (77))  \cdot  e_{100} - (1 - e_{99}))^{2} \\
& + (e_{101}  \cdot  (1 - e_{101}))^{2} + (e_{101}  \cdot  ((C_{24}) - (C_{13}) - (e_{103}^{2} \\
& + e_{104}^{2} + e_{105}^{2} + e_{106}^{2})))^{2} \\
& + ((1 - e_{101})  \cdot  ((C_{13}) - (C_{24}) - 1 - (e_{107}^{2} + e_{108}^{2} + e_{109}^{2} \\
& + e_{110}^{2})))^{2} + (e_{98} - (e_{99}  \cdot  e_{101}))^{2} + (e_{112} - (C_{13} \\
& + 5))^{2} + (e_{115} - (C_{13} + 5))^{2} + (e_{114} - (e_{115} - 1))^{2} \\
...
& + 1))^{2} + (f[t+1] - ((C_{11})  \cdot  (e_{131}) + (1 - C_{11})  \cdot  (f)))^{2} \\
& + (e_{133} - (g + 1))^{2} + (e_{132} - ((C_{23})  \cdot  (e_{133}) \\
& + (1 - C_{23})  \cdot  (g)))^{2} + (g[t+1] - ((C_{11})  \cdot  (g) \\
& + (1 - C_{11})  \cdot  (e_{132})))^{2} + (p[t+1] - (C_{0}))^{2} + (q[t+1] - (C_{13}))^{2} = 0
\end{align*}
\end{document}